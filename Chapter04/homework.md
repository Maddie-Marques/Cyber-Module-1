...
Step 2 — Your MAC address anatomy sketch (OUI / device-specific split, I/G and L/G bits labeled)

A sketch of a 48-bit MAC address split into its OUI (vendor) and device-specific halves, with the I/G and L/G bits labelled in the first byte.
<img width="1472" height="642" alt="image" src="https://github.com/user-attachments/assets/b4f965a3-9e69-4ef2-a4c4-503ea8e0b0eb" />
...
Step 5 — Your Step 4 decoding of 10GBaseLR, 1000BaseSX, and 100BaseTX from the naming pattern alone
